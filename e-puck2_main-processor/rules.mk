...
$(ACPPOBJS) : $(OBJDIR)/%.o : %.cpp $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
...
$(TCPPOBJS) : $(OBJDIR)/%.o : %.cpp $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ACOBJS) : $(OBJDIR)/%.o : %.c $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(TCOBJS) : $(OBJDIR)/%.o : %.c $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ASMOBJS) : $(OBJDIR)/%.o : %.s $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
...
$(ASMXOBJS) : $(OBJDIR)/%.o : %.S $(GLOBAL_PATH)/Makefile $(GLOBAL_SRC_DEP)
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
